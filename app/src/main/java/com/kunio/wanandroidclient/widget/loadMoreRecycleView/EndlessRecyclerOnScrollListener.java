...
//        }
        ...
        if (recyclerView instanceof LoadMoreRecyclerView) {
            ...
            if (recyclerView.getAdapter() instanceof HeaderAndFooterRecyclerViewAdapter) {
                footerCount = ((HeaderAndFooterRecyclerViewAdapter) recyclerView.getAdapter())
                        .getFooterViewsCount();
            }
            ...
            if (visibleItemCount > 0
                    ...
                    && (lastVisibleItemPosition) >= totalItemCount - footerCount - 1
                    && (totalItemCount - footerCount) >= triggerCount) {
